var ECharts = {
	ChartConfig: function(container, option) { //container:为页面要渲染图表的容器，option为已经初始化好的图表类型的option配置
		         
		var chart_path = "../Static/lib/echarts/echart"; //配置图表请求路径   
		var map_path = "../Static/lib/echarts/js/echarts-all"; //配置地图的请求路径    
	...
	ChartOptionTemplates: {
		...
		Map: function(data, name, is_stack) { //其他的图表配置，如柱图+折线、地图
